...
<html>
  ...
  <div id="bigdamnwrapper">
    ...
    <div class="blogpost">
      ...
      <p>Take a look at current and past events here. Click an event for more details,
        registration, or to report possible inappropriate content.</p>
      <a href ="pastEvents.php">Check out past events here</a></br>
    </div>
        ...
        <?php
         ...
         while($row = mysqli_fetch_assoc($queryresult)){
              ...
              if(strtotime($event_date) < strtotime($date)){
                // don't print if it's a past event
              }else{
                if($thumbnail_event === null){
                  echo "<div class=\"blogpost\">";
                  echo "<h2><a href = \"event.php?event_id=$event_id&current=yes\">$event_name, $event_location, $event_date</a></h2>";
