...
<html>
  <head>
    <meta charset="utf-8">
    <title>New report - The Great North East</title>
  ...
  <div id="bigdamnwrapper">
    ...
    <div class="blogpost">
      <?php
        ...
        $insertSQL = "INSERT INTO tgne_reports (report_item) VALUES ('$feedback_id')";
	       $success = mysqli_query($conn, $insertSQL) or die(mysqli_error($conn));
        if($success === true){
          echo "Success, item reported.";
        }else{
          echo "Error, report not sent.";
        }
        echo "<p><a href=\"feedback.php\">Click here to go back</a></p>";
      ?>
    </div>
    <div class="divider"></div>
    <div class="footer">
