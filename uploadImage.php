...
<html>
  ...
  <div id="bigdamnwrapper">
    ...
    <div class="blogpost">
      ...
      $sql = "INSERT INTO images (image_url, image_title, image_event) VALUES ('$upload_url','$filename', '$event_id') ";

      $imageresults = mysqli_query( $conn,$sql );

      echo "<p>Image uploaded!</p><br /><a><p><a href=\"editMedia.php?event_id=$event_id\">Click here to go back</a></p>";
