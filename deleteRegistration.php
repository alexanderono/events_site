  ...
  <div id="bigdamnwrapper">
    ...
    <div class="blogpost">
      <?php
        ...
        $insertSQL = "DELETE FROM tgne_registrants WHERE registrant_id = $registrant_id";
	       $success = mysqli_query($conn, $insertSQL) or die(mysqli_error($conn));
        if($success === true){
          echo "Success, unregistered.";
        }else{
          echo "Error, not unregistered.";
        }
        echo "<p><a href=\"registrations.php\">Click here to go back</a></p>";
