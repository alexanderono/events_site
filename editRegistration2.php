      ...
      <?php
        ...
        while($row = mysqli_fetch_assoc($queryresult)){
          ...
          echo "<h1>Leave feedback</h1>
            <p>Leave feedback for: $event_name</p>
            <form method=\"post\" action=\"newFeedback.php\" onsubmit=\"return confirm('Are you sure?');\">
              <div><input type=\"hidden\" name=\"registrant_id\" value=\"$registrant_id\"></div>
              <div><input type=\"hidden\" name=\"event_id\" value=\"$event_id\"></div>
              <div><input type=\"text\" name=\"feedback\" size=\"100\" value=\"\"></div>
              <div>Rating out of 5: <select name=\"rating\">
